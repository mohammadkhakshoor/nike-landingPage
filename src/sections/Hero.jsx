        ...
        >
            <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
                ...
                <h1 className="mt-10 text-8xl font-bold font-palanquin max-sm:text-[72px] max-sm:leading-[82px]">
                    <span className=" xl:bg-white xl:whitespace-nowrap relative z-2 pr-10">
                        The New Arrival
                    </span>
                    <br /> <span className=" text-coral-red mt-3 inline-block">Nike</span> Shoes
                </h1>
                <p className="mt-6 mb-14 font-montserrat stroke-slate-gray text-[18px]">
                ...
                <div className="flex gap-16  mt-20 justify-start items-start w-full  flex-wrap ">
                    {statistics.map((item, index) => {
                        return (
                            <div key={index}>
                                <p className=" leading-10 mb-2 font-palanquin text-[48px] font-bold">
                                    {item.value}
                                </p>
                                <p className="text-[16px] text-slate-gray  font-montserrat">{item.label}</p>
                            </div>
                        );
                    })}
                </div>
