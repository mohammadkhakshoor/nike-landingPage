...
const Hero = () => {
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28 dark:bg-darkback">
        <p className="text-xl font-montserrat text-coral-red">
          Our Summer collections
        </p>
        <h1 className="mt-10 text-8xl font-bold font-palanquin max-sm:text-[72px] max-sm:leading-[82px]">
          <span className=" xl:bg-white  xl:whitespace-nowrap relative z-10 pr-10          xl:dark:bg-darkback dark:text-white">
            The New Arrival
          </span>
