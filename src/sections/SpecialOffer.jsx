  ...
  return (
    <section className="max-container justify-center flex-col-reverse lg:flex-row flex gap-20  items-center">
      ...
      <div className="relative xl:w-2/5 flex flex-col   items-start w-full max-xl:px-3 ">
        ...
        <p className=" mb-10 font-montserrat text-slate-gray text-[18px] dark:text-white">
        ...
        <div className="flex flex-col lg:flex-row  gap-3">
          ...
          <button className="  font-montserrat border border-black leading-6 px-8 py-4 rounded-[999px]  gap-4 text-[18px] text-black dark:border-white dark:text-white">
