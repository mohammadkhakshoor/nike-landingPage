        ...
        <section className="max-container">
            <div className=" flex flex-col items-center mb-20">
                <h3 className=" text-4xl font-bold font-palanquin max-sm:text-[48px] max-sm:leading-[48px]">
                    What Our
                    <span className=" text-coral-red mt-3 inline-block">Customers </span> Say?
                </h3>
                ...
                {reviews.map((rew) => {
                    return (
                        ...
                        >
                            ...
                            />
                            <p className="mt-6 mb-4 font-montserrat text-slate-gray text-[18px] text-center">
                                {rew.feedback}
                            </p>
                            ...
                            <p className="text-3xl  font-montserrat font-bold mb-2">{rew.customerName}</p>
                        </div>
                    );
                })}
            </div>
