        ...
        <section className="max-container flex flex-col md:flex-row-reverse justify-around gap-12 sm:gap-0">
            <div className="relative xl:w-2/5 flex flex-col   items-start w-full max-xl:px-3 ">
                <h1 className=" text-4xl font-bold font-palanquin max-sm:text-[48px] max-sm:leading-[48px]">
                    We Provide You <span className=" text-coral-red mt-3 inline-block">Super </span>
                    <br className="none" />
                    <span className=" text-coral-red mt-3 inline-block"> Quality</span> Shoes
                </h1>
                <p className="mt-6 mb-4 font-montserrat stroke-slate-gray text-[18px]">
                ...
                <p className=" mb-10 font-montserrat stroke-slate-gray text-[18px]">
