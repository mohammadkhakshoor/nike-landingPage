    ...
    <section className="max-container flex flex-1  justify-center flex-wrap gap-9 ">
      {services.map((service) => {
        return (
          <div
            key={service.imgURL}
            className=" shadow-3xl  dark:shadow-zinc-800 py-12 px-10 flex-1 sm:w-[350px] sm:min-w-[350px]"
          >
            <img
              ...
              alt="service image"
            />
            <h2 className="text-3xl  font-montserrat font-bold mb-2 dark:text-white">
              {service.label}
            </h2>
